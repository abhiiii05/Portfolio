...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Abhijith Viju Priya Rani
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <h3 className="home__subtitle">Freshman @ IIIT Vadodara</h3>
            <p className="home__description">My name is Abhijith Viju Priya Rani, and I am a driven and enthusiastic freshman at the
